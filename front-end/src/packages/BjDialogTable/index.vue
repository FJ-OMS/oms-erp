  ...
  >
    <el-row :gutter="10">
      ...
      <el-col :span="12">
        <!-- 查询 -->
        <el-row :gutter="10" class="top">
          <el-col v-for="(searchJson, i) in config.search" :key="i" :span="6"> </el-col>
          <el-col :span="searchSpan" class="search-span">
            <el-button size="mini" @click="onClear">清 空</el-button>
            <el-button size="mini" @click="onDelete">删 除</el-button>
          </el-col>
        </el-row>
        <el-table
          :data="tags"
...
export default {
  ...
  data() {
    return {
      ...
      /** */
      DEFAULT_SELECTED_DATA: [], // 不变  // pageDataJson['default']: [...DEFAULT_SELECTED_DATA], //跟随 删除操作 变动
    };
  },
  computed: {
    classID() {
  ...
  methods: {
    ...
    reset() {
      ...
      this.pageDataJson = { default: [...this.DEFAULT_SELECTED_DATA] };
    },
    /** 查询 */
    search() {
      this.resetSelected();
    ...
    checkSelectable(row, index) {
      ...
      // console.log(!this.disabled.includes(row[this.rowKeys]));
