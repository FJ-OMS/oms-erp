package org.skyer.channel.infra.remote.api.impl;
...
import org.skyer.channel.infra.remote.api.RemoteCustomizeService;
...
public class RemoteCustomizeServiceImpl implements RemoteCustomizeService {
    ...
    public RemoteCustomizeServiceImpl(RestTemplate restTemplate, ChannelProperties channelProperties,
    ...
    public List<MethodMetaData> fetchServiceMethods(String serviceName, String packageNames) {
        ...
        String url = channelProperties.getFullHttpProtocol() + serviceName + SCAN_URI + params;
