...
/**
 * @author xurongfa 2022-04-25 15:48
 */
@Data
public class WarehouseWarrantPageQueryDTO extends PageRequest {
    @ApiModelProperty("单号 入库通知单号，三方订单号，内部单号，前置单号")
    ...
    @ApiModelProperty("入库状态 STOCK.INPUT_STATUS")
