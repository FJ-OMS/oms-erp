<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5" class="top-left-btn">
        <el-button type="primary" :disabled="multiple" class="delete-btn" @click="onDeleteSelected"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5" class="top-left-btn">
        <el-button type="primary" class="main-btn" @click="handleAdd">添加用户</el-button>
      </el-col>
...
export default {
  ...
  methods: {
     ...
     */
    handleAdd() {
      this.disabledIds = this.userTableData.map(item => {
        return item.id;
      });
