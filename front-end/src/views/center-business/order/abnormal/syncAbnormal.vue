  ...
  <div class="app-container">
    ...
    >
      ...
      <template v-slot:tableOperation>
        <el-col>
          <el-button class="main-btn" type="primary">刷新异常</el-button>
          <el-button type="primary">自动刷新设置</el-button>
        </el-col>
      </template>
          ...
          >
            <template slot-scope="scope">
              ...
              <template v-else-if="col.prop === 'innerOrderSn'">
                ...
                <BjCopyIcon type="el-button" :copy="scope.row.innerOrderSn" />
              </template>
  ...
  data() {
    return {
      ...
      labelList: [
        ...
        { label: '异常类型', prop: 'abnormalType', isCheck: true, disabled: false },
        { label: '异常原因', prop: 'earlyCause', isCheck: true, disabled: false },
        { label: '处理状态', prop: 'status', isCheck: true, disabled: false },
        { label: '异常时间', prop: 'earlyTime', isCheck: true, disabled: false, width: 135 },
        ...
        { label: '付款时间', prop: 'payTime', isCheck: true, disabled: false, width: 135 },
