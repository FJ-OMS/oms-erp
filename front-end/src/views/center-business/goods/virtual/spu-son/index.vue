  ...
  <div class="app-container">
    ...
    >
      ...
      <template v-slot:tableOperation>
        <el-col>
          <el-button
            v-permission:BusinessGoodsVirtualSpuSonAdd
            type="primary"
            class="main-btn"
            @click="onAdd"
            >新增</el-button
        ...
        <template v-for="(col, index) in dropCols">
          ...
          >
            <template slot-scope="props">
              <el-button
                v-permission:BusinessGoodsVirtualSpuSonView
                type="text"
                @click="onView(props.row)"
                >查看</el-button
              >
              <el-button
                v-permission:BusinessGoodsVirtualSpuSonEdit
                type="text"
                class="edit-btn"
              ...
              >
              <el-button
                v-permission:BusinessGoodsVirtualSpuSon_Delete
                type="text"
                class="delete-btn"
...
export default {
  ...
  data() {
    return {
      ...
      queryApi: goodsApi.getSpuSonNum,
      // 查询参数
      queryParams: {
        spuCode: null,
        spuName: null,
  ...
  methods: {
    ...
    /** 新建 */
    onAdd() {
      this.$router.push({ name: 'BusinessGoodsVirtualSpuSonAdd' });
    },
    /** 查看 */
    onView(row) {
      this.$router.push({
    ...
    deleteApi(API_DATA) {
      goodsApi.deleteSpuSonNum(API_DATA).then(res => {
