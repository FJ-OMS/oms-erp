package org.skyer.goods.infra.remote.api.impl;
...
import org.skyer.goods.infra.remote.api.RemoteCustomizeService;
...
public class RemoteCustomizeServiceImpl implements RemoteCustomizeService {
    ...
    public RemoteCustomizeServiceImpl(RestTemplate restTemplate, GoodsProperties goodsProperties,
    ...
    public List<MethodMetaData> fetchServiceMethods(String serviceName, String packageNames) {
        ...
        String url = goodsProperties.getFullHttpProtocol() + serviceName + SCAN_URI + params;
