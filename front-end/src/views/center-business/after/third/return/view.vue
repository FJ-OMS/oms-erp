<template>
  <div class="app-container bj-label-colon label-width-8 bj-el-input-disabled">
      ...
      <div class="bj-col bj-col-14">
        ...
        <div v-if="baseInfo.exceptionStatus == 0" class="bj-form-item">
          ...
          <div class="flex align-items ml20">
            ...
            <div class="flex">已成功转为内部退货退款单</div>
          </div>
        </div>
    ...
    <div class="bj-row mt20">
      ...
      <div class="bj-col">
        ...
        <div class="bj-form-item">
          ...
          <div class="bj-form-item-value">
            {{ BJ_AFTER_REFUND_GOODS_REASONS.bjGet(baseInfo.reason) }}
          </div>
        </div>
        <div class="bj-form-item">
      ...
      <div class="bj-col">
        ...
        <div class="bj-form-item">
          ...
          <div class="bj-form-item-value">{{ receiverInfo.returnName }}</div>
        </div>

        <div class="bj-form-item">
          <div class="bj-form-item-label">退货人手机</div>
          <div class="bj-form-item-value">{{ receiverInfo.mobile }}</div>
        </div>

        <div class="bj-form-item">
          <div class="bj-form-item-label">退货人地址</div>
          <div class="bj-form-item-value">{{ cptAddress }}</div>
        </div>
      </div>

      <!-- 退货物流信息 -->
      <div class="bj-col">
        <div class="bj-form-title">退货物流信息</div>

        <div class="bj-form-item">
          <div class="bj-form-item-label">退货物流</div>
          <div class="bj-form-item-value">{{ logisticsInfo.logisticsCompanyName }}</div>
        </div>

        <div class="bj-form-item">
          <div class="bj-form-item-label">退货物流单号</div>
          <div class="bj-form-item-value">{{ logisticsInfo.logisticsNo }}</div>
        </div>

        <div class="bj-form-item">
          <div class="bj-form-item-label">退货收件人</div>
          <div class="bj-form-item-value">{{ receiverInfo.receiveName }}</div>
        </div>

        <div class="bj-form-item">
          <div class="bj-form-item-label">退货收件人手机号</div>
          <div class="bj-form-item-value">{{ receiverInfo.receiveMobile }}</div>
        </div>

        <div class="bj-form-item">
          <div class="bj-form-item-label">退货地址</div>
          <div class="bj-form-item-value">
            {{ cptReceiveAddress }}
          </div>
        </div>
    ...
    <div class="bj-row mt20">
      ...
      <div class="bj-col">
        ...
        <div class="bj-form-item">
          <div class="bj-form-item-label">三方退货单号</div>
          <div class="bj-form-item-value">
        ...
        <div class="bj-form-item">
          ...
          <div class="bj-form-item-value">
            <span
              class="link"
              @click="$toBusinessAfterInternalReturnView(baseInfo.innerRefundNo)"
    ...
    <div class="bj-row mt20">
      ...
      <div class="bj-col bj-col-24">
        <div class="bj-form-title">退货商品信息</div>
...
export default {
  ...
  computed: {
    ...
    receiverInfo() {
      return this.form.thirdPartyAfterReceiverInfo || {};
    },
    logisticsInfo() {
      return this.form.thirdPartyAfterSaleLogistics || {};
    },
    cptAddress() {
      let text = '';
      text += this.receiverInfo.province || '';
      text += this.receiverInfo.city || '';
      text += this.receiverInfo.district || '';
      text += this.receiverInfo.address || '';
      return text;
    },
    cptReceiveAddress() {
      let text = '';
      text += this.receiverInfo.receiveProvince || '';
      text += this.receiverInfo.receiveCity || '';
      text += this.receiverInfo.receiveDistrict || '';
      text += this.receiverInfo.receiveAddress || '';
      return text;
    },
  },
  watch: {
