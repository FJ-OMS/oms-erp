package org.skyer.tags.infra.remote.api.impl;
...
import org.skyer.tags.infra.remote.api.RemoteCustomizeService;
...
public class RemoteCustomizeServiceImpl implements RemoteCustomizeService {
    ...
    private final TagsProperties tagsProperties;
    ...
    public RemoteCustomizeServiceImpl(RestTemplate restTemplate, TagsProperties tagsProperties,
    ...
    public List<MethodMetaData> fetchServiceMethods(String serviceName, String packageNames) {
        ...
        String url = tagsProperties.getFullHttpProtocol() + serviceName + SCAN_URI + params;
