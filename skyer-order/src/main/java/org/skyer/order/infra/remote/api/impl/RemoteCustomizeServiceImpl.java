package org.skyer.order.infra.remote.api.impl;
...
import org.skyer.order.infra.remote.api.RemoteCustomizeService;
...
public class RemoteCustomizeServiceImpl implements RemoteCustomizeService {
    ...
    public RemoteCustomizeServiceImpl(RestTemplate restTemplate, OrderProperties orderProperties,
    ...
    public List<MethodMetaData> fetchServiceMethods(String serviceName, String packageNames) {
        ...
        String url = orderProperties.getFullHttpProtocol() + serviceName + SCAN_URI + params;
